...
#%%
directory = "/Users/flor/Pycharm/PILOT-VIS/predsplot/output/"
...
predsplot(X, coefficients, y_hat, n_max=5, fig_size=(5,3), truncate_total_pred=True, variable_tick_width = True,
