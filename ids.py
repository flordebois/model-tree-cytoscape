...
# --- C New Tree card -----------------------------------------------------
NEW_TREE_COLLAPSE = "new-tree-collapse"
NEW_TREE_TOGGLE_BUTTON = "new-tree-toggle-button"

INPUT_DATASET = "input-dataset"
MODAL_CSV = "modal-csv"
MODAL_CSV_UPLOAD = "model-csv-upload"
MODAL_CSV_FILE_NAME = "modal-csv-file-path"
MODAL_CSV_INPUT_TARGET_COL = "modal-input-target-col"
MODAL_CSV_BTN_CANCEL = "button-cancel-csv"
MODAL_CSV_BTN_CONFIRM = "button-confirm-csv"
MODAL_CSV_FEEDBACK = "csv-feedback"
...
EDIT_TREE_TOGGLE_BUTTON = "edit-tree-button"
...
# --- F Highlight card ----------------------------------------------------
HIGHLIGHT_COLLAPSE = "highlight-collapse"
HIGHLIGHT_TOGGLE_BUTTON = "highlight-toggle-button"
